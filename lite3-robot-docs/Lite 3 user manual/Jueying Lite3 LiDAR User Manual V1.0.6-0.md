# Jueying Lite3 LiDAR User Manual V1.0.6-0

Source: [Jueying Lite3 LiDAR User Manual V1.0.6-0.pdf](<Jueying Lite3 LiDAR User Manual V1.0.6-0.pdf>)
...
Important Safety Tips          2       3.9.3 Auto Mode             21
### 3.10 Payload                    21
...
1.1 Overview                   4       3.11.1 Emergency STOP       21
1.2 Product List               4       3.11.2 Fall Down & Get up   21
#### 3.11.3 Overtemperature      22
...
2.2.3 LED Eyes             9   4.4 Disposal                    24

2.3 "DEEP Robotics" APP       10   5 FAQs                          25
#### 2.3.1 Home Page           10

#### 2.3.2 Control Page        11   6 Transport & Storage           26
...
2.3.5 Action List         14   6.2 Storage                     26
#### 2.3.6 Settings Page       14   7 Service & Warranty            27

3 Operation                   16   7.1 After-Sales Service         27
3.1 Preparation               16   7.2 Warranty Policy             27
3.1.1 Environment         16   7.3 Warranty Coverage           27
3.1.2 Carrying            16   7.4 Repair Instructions         28
#### 3.1.3 Checking            16
...
Jueying Lite3 is an intelligent quadruped robot with 12 degrees of freedom, featuring a
variety of gaits and movements. Jueying Lite3 LiDAR provides SDK for motion control
...
Standing Size (Length × Width × Height)       610mm×370mm×503mm

Sitting Size (Length × Width × Height)        680mm×370mm×225mm
...
obstacles
㉛ Obstable
㉙ AI Options               Automatically bypass obstacles
Avoidance
㉜ Auto Mode Robot switches to Auto Mode
...
Avoidance] option in [㉙AI Options]. If the [㉜Auto Mode] is not automatically enabled after
that, please manually click [㉜Auto Mode]. When [㉛Obstable Avoidance] and [㉜Auto
Mode] are both turned on, return to Control Page and pushing the joysticks to control the
movement of the robot, the robot can detect obstacles on its way and avoid them.
20
...
Click the [⑥Settings] button to enter the Settings Page and select the [㉜Auto Mode]
option in [㉙AI Options] to switch to Auto Mode and then the robot can execute a secondary
development case (only LiDAR supports this function). Read the Jueying Lite3 Perception
Development Manual for instructions.

### 3.10 Payload

Users can screw devices into the thread holes on the back of robot (unit: mm).

When the weight of devices reaches or exceeds 2.5 kilograms, robot's
...
Wide Angle Camera, Ultrasonic Radars, Depth Camera, Laser
One year
Radar, AI Computer, Control System
