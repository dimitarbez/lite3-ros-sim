# Jueying Lite3 Basic User Manual V1.0.5-0

Source: [Jueying Lite3 Basic User Manual V1.0.5-0.pdf](<Jueying Lite3 Basic User Manual V1.0.5-0.pdf>)
...
Content                             3.4 Connection                  18
### 3.5 Reset to Zero               19

### 3.6 Motion Control              19

Statement2                         3.7 Action List                 19
### 3.8 Voice Command               20

Reading Tips                   2
### 3.9 AI Options                  21

Description of Symbol          2       3.9.1 Auto Stop             21
Get Help                       2   3.10 Payload                    21

Important Safety Tips          3   3.11 Emergency Operation        21
#### 3.11.1 Emergency Stop       21

1 Introduction                 5       3.11.2 Overtemperature      21
#### 3.11.3 Fall Down & Get up   22

### 1.1 Overview                   5

#### 3.11.4 Low Battery          22

1.2 Product List               5       3.11.5 Other                22
1.3 Product Parts              6   3.12 Power Off                  22
### 1.4 Main Specifications        6
...
2.1 Motion Mode and Gait       8   4.2 Battery                     23
2.2 Description of Lighting    8   4.3 Other Precautions           24
#### 2.2.1 Charger              8
...
#### 2.2.3 LED Eyes             9   5 FAQs                          25

2.3 "DEEP Robotics" APP       10
#### 2.3.1 Home Page           10

## 6 Transport & Storage           26

2.3.2 Control Page        11   6.1 Transportation              26
2.3.3 Flat Gait           12   6.2 Storage                     26
#### 2.3.4 RUG Gait            13

#### 2.3.5 Action List         14   7 Service & Warranty            27

2.3.6 Settings Page       14   7.1 Warranty Policy             27
3 Operation                   16   7.2 Warranty Coverage           27
### 7.3 Repair Instructions         27
...
Jueying Lite3 Basic User Manual

## 1 Introduction

### 1.1 Overview

Jueying Lite3 Basic is an intelligent quadruped robot with 12 degrees of freedom, featuring
a variety of gaits and movements.
370mm                                              610mm
...
Replaceable Battery×1              Charger×1                   Charging Base ×1

Qualified Certificate×1         Warranty Card×1               Fold-out Guide×1
...
Standing Size (Length × Width × Height)       610mm×370mm×406mm

Sitting Size (Length × Width × Height)        680mm×370mm×115mm
...
Max Speed of Fast Gait                                  2.5m/s

Max Speed of Medium Gait                                1.3m/s

Max Speed of Slow Gait                                  0.5m/s
...
No-load Duration                                        1.5h~2h (Rapid interchanged of batteries)
...
The robot can perform actions such as Backflip, Carpet Backflip, Hello, Twist, Moonwalk,
Long Jump, Twist Jump, and Turn Over.
...
㉗ Perception                              Automatically stop when encountering
㉙ AI Options ㉚ Auto Stop
obstacles (see 3.9.1 for details)
㉜ Speaker                  Turn on and off robot speaker
㉛ Other                                   A safety tip will appear before performing
㉝ Action Double-Check
Long Jump, Backflip or Carpet Backflip
...
Press, then press and hold the power button until the LED light flashes once, the robot
starts up, and the power light shows the current battery level.
...
1. Contact after-sales personnel for "DEEP Robotics" APP. "DEEP Robotics" APP supports
Android 6.0 or later, and does not yet support iOS.
...
When the robot is standing or sitting still, user can click the [⑱Action] button to open the
action list and select an action. Among them, Custom Action is a laboratory function that
can be used to perform the actions developed by users.

- To perform Long Jump, make sure that there are no obstacles within
2m in front of the robot; to perform Backflip or Carpet Backflip, make
sure there are no obstacles within 2m behind.
- If a peripheral device is installed on the back of the robot, the robot
may fall and damage the peripheral device by Turn Over, Backflip, and
Carpet Backflip. Please try to avoid using it as much as possible.
- The robot does not respond to Emergency Stop in the air.
- When the robot passes through stairs or slopes, do not stand on the
stairs, platforms, or slopes below the robot to avoid potential personal
injury if the robot falls.
...
When the weight of devices reaches or exceeds 5 kilograms, robot's
...
When the robot swings its legs, shakes violently or other abnormal phenomena occurs in
use, press [⑦STOP] to let the robot into a protected state. The robot will automatically get
down, and after identifying the problem, cancel Emergency STOP to continue to use.

#### 3.11.2 Overtemperature
...
as possible.
When the robot's power is below 20%, low power protection will be triggered and the robot
will not respond to motion commands. Please power off the robot and replace the battery,
refering to "3.2 Charging" for specific instructions on replacing batteries.
...
Press, press and hold the power button until the LED light flashes once more. Then the
robot LED Eyes and the battery LED lights go out, indicating the shutdown is completed.
...
Wide Angle Camera, Ultrasonic Radars, Control System                        One year
...
contact DEEP Robotics immediately, otherwise it is regarded as the end of this after-
sale service without dispute.
