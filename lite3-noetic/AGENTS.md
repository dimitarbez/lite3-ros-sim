...
- Neutral is the only checked-in normal commissioned category. Joy, Sadness, Fear, and Anger also have physically and visually accepted reactions; Fear's final animation was observed working correctly on the robot. Their normal chat selection and retargeting remain incomplete or live-unvalidated, so the allowlist stays `neutral`. Affection, Curiosity, Disgust, and Surprise remain planned.
